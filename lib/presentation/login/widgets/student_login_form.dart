...
import 'package:hostel_management_pro/infrastructure/theme/styles/text_styles.dart';

import '../../../domain/core/base/enums/api_status.dart';
import '../../../domain/core/widgets/profile_text_form_field.dart';
import '../../../infrastructure/navigation/routes.dart';
import '../controllers/login.controller.dart';
import 'fade_in_up_widget.dart'; // Your FadeInUp widget

class StudentLoginForm extends GetView<LoginController> {
          ...
          FadeInUp(
            ...
            child: Container(
              ...
              child: ProfileTextFormField(
                ...
                controller: controller.studentLoginMobileController.value,
            ...
            child: Container(
              ...
              child: Obx(
                () => ProfileTextFormField(
                  ...
                  controller: controller.studentLoginPasswordController.value,
                  showText: controller.isStudentPasswordVisible.value,
                  maxLength: 50,
                  showPrefixIcon: const Icon(
                  ...
                  showSufixIcon: IconButton(
                    icon: Icon(
                      controller.isStudentPasswordVisible.value
                          ? Icons.visibility_off_rounded
                          : Icons.visibility_rounded,
                      color: Colors.grey[600],
                    ),
                    onPressed: () => controller.toggleStudentPasswordVisibility(),
                  ),
                  borderRadius: BorderRadius.circular(12),
                  contentPadding: const EdgeInsets.symmetric(
                    horizontal: 0,
          ...
          FadeInUp(
            ...
            child: Center(
              child: GestureDetector(
                onTap: () {
                  Get.offNamed(Routes.SIGNUP, arguments: {'tab': 1});
                },
                child: RichText(
                  text: const TextSpan(
                    children: [
